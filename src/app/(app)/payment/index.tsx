...
export default function PaymentScreen() {
    ...
    const generateDefaultQR = () => {
        ...
        const userName = currentProfile.display_name || currentProfile.full_name || 'User';
    ...
    const handleQRCodeScanned = async (result: any) => {
        ...
        try {
            ...
            if (paymentRequest.type === 'payment_request') {
                ...
                if (paymentRequest.amount === 0 || parseFloat(paymentRequest.amount) === 0) {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            Alert.alert('Payment Successful!', `Successfully sent $${amount} to ${paymentData?.recipientName || 'recipient'}`);
                ...
                <View className='flex-1 p-6 bg-white'>
                    ...
                    <View className='mb-4'>
                        ...
                        <View className='flex-row items-center px-3 py-2 border border-gray-300 rounded-lg'>
                            <Text className='mr-2 text-lg font-bold text-blue-600'>$</Text>
                            <TextInput
                                placeholder='0.00'
                                value={amount}
                                ...
                                editable={!(paymentData && parseFloat(paymentData.amount) > 0)}
                            />
                        </View>
