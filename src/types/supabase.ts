...
export type TransactionRequest =
	Database['public']['Tables']['transaction_requests']['Row'];
export type TransactionRequestInsert =
	Database['public']['Tables']['transaction_requests']['Insert'];
export type TransactionRequestUpdate =
	Database['public']['Tables']['transaction_requests']['Update'];
...
export type UserDashboardStats =
	Database['public']['Views']['user_dashboard_stats']['Row'];
